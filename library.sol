...
contract QR {
    ...
    function eigensolve() public pure returns (int256[] memory) {
        ...
        a[0][1] = -2e18;
        a[1][1] = -3e18;
        return a.eigenvalues(); // Returns 
    }

    function solveMat(int256[][] memory a) public pure returns (int256[] memory) {
        return a.convertTo59x18().eigenvalues();
    }

    function linearRegression(int256[][] memory a, int256[] memory b) public pure returns (int256[][] memory) {
        int256[][] memory q;
        int256[][] memory r;
